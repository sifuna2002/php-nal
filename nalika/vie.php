        ...
        <nav id="sidebar" class="">
            ...
            <div class="nalika-profile">
                <div class="profile-dtl">
                    ...
                    <h2><?php
                    echo $c;
                    ?><span class="min-dtn"></span></h2>
                    <form method="post">
                        <button name="clear"><a href="../logout.php">Logout</a>
                        </button>
                    </form>
                </div>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="vote.php" aria-expanded="false"><i
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button"
                                                        ...
                                                        <span class="admin-name"><?php echo $c ?></span>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2022 <a href="https://sifunaportfolio.vercel.app/">Sifuna</a> All rights
                                reserved.</p>
                        </div>
                    </div>
                </div>
